 ...
 */
class getLangageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LangageRepository' shared autowired service.
     *
     * @return \App\Repository\LangageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LangageRepository.php';

        return $container->privates['App\\Repository\\LangageRepository'] = new \App\Repository\LangageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
