 ...
 */
class getPhraseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhraseRepository' shared autowired service.
     *
     * @return \App\Repository\PhraseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhraseRepository.php';

        return $container->privates['App\\Repository\\PhraseRepository'] = new \App\Repository\PhraseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
